...
from .views import (
    ...
    hierarchy,
    WalletMe,
    FranchiseEducationPDFListView,
    FranchiseAgreementPDFView,
    FranchiseMonthlyWorkReportView,
    FranchiseWalletMe,
    FranchiseWalletTransferToWithdrawal,
    AdminFranchiseEducationPDFView,
    AdminFranchiseAgreementTemplateView,
    AdminFranchiseWalletSettingsView,
    AdminFranchiseRewardCreditView,
    AdminFranchiseWorkApprovalView,
...
urlpatterns = [
    ...
    path('franchise/education-pdfs/', FranchiseEducationPDFListView.as_view(), name='franchise_education_pdfs'),
    path('franchise/agreement/pdf/', FranchiseAgreementPDFView.as_view(), name='franchise_agreement_pdf'),
    path('franchise/monthly-work-report/', FranchiseMonthlyWorkReportView.as_view(), name='franchise_monthly_work_report'),
    path('franchise/wallet/me/', FranchiseWalletMe.as_view(), name='franchise_wallet_me'),
    path('franchise/wallet/transfer-to-withdrawal/', FranchiseWalletTransferToWithdrawal.as_view(), name='franchise_wallet_transfer_to_withdrawal'),
    path('admin/franchise/education-pdfs/', AdminFranchiseEducationPDFView.as_view(), name='admin_franchise_education_pdfs'),
    path('admin/franchise/agreement-template/', AdminFranchiseAgreementTemplateView.as_view(), name='admin_franchise_agreement_template'),
    path('admin/franchise/wallet/settings/', AdminFranchiseWalletSettingsView.as_view(), name='admin_franchise_wallet_settings'),
    path('admin/franchise/wallet/reward-credit/', AdminFranchiseRewardCreditView.as_view(), name='admin_franchise_reward_credit'),
    path('admin/franchise/wallet/work-approvals/', AdminFranchiseWorkApprovalView.as_view(), name='admin_franchise_work_approvals'),
