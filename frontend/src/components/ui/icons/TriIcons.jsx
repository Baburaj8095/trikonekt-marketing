...
const Svg = ({ children, size = 48, stroke = 1.8, viewBox = "0 0 24 24", ...rest }) => (
  <svg
    width={size}
    height={size}
    viewBox={viewBox}
...
// Wealth Galaxy â€” abstract orbit/galaxy
