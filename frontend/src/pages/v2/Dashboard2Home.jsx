...
export default function Dashboard2Home({ isPrime = false }) {
  ...
  const triAppItems = useMemo(() => [
    ...
    { key: "ecommerce", label: "Eâ€‘commerce", route: "/trikonekt-products", icon: <ECommerceIcon /> },
  ...
  // Top horizontal action rail â€” exact order requested
  ...
  // TRI Product card â€” square, premium, uncluttered (icon + label only)
  ...
  return (
    <Box>
      ...
      {/* 3) TRI PRODUCTS â€” 2-column premium grid, no horizontal scroll */}
      <Box sx={{ pt: 3 }}>
      ...
      {/* 4) AGENCY PRODUCTS â€” horizontal carousel style retained */}
      <Box sx={{ pt: 2 }}>
