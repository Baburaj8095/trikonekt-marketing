  ...
  return (
    <div>
      <div style={{ marginBottom: 16 }}>
        <h2 style={{ margin: 0, color: "#0f172a" }}>Eâ€‘commerce Categories</h2>
      ...
      >
        ...
        <div>
          {filtered.map((r) => (
            ...
            >
              <div>#{r.id}</div>
              <div style={{ overflow: "hidden", textOverflow: "ellipsis" }}>{r.key || r.slug || "â€”"}</div>
              <div style={{ overflow: "hidden", textOverflow: "ellipsis" }}>{r.label || r.name || "â€”"}</div>
              <div>{r.order ?? 0}</div>
