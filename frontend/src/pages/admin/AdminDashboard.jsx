...
export default function AdminDashboard() {
  ...
  const cards = useMemo(() => {
    ...
    return [
      ...
      { title: "Join Subscription", icon: ConfirmationNumberRoundedIcon, to: "/admin/promo-purchases?kind=750&status=APPROVED", metrics: packageMetrics(subscription750.overall) },
      { title: "Join Subscription Coupon Pocket", icon: ConfirmationNumberRoundedIcon, to: "/admin/promo-purchases?kind=750&status=APPROVED", metrics: packageMetrics(subscription750.couponPocket) },
      { title: "Join Subscription Self Package Pocket", icon: ShoppingCartRoundedIcon, to: "/admin/promo-purchases?kind=750&status=APPROVED", metrics: packageMetrics(subscription750.selfPackagePocket) },
      { title: "Join Subscription Add Money", icon: AccountBalanceWalletRoundedIcon, to: "/admin/promo-purchases?kind=750&status=APPROVED", metrics: packageMetrics(subscription750.addMoney) },
      { title: "Join Subscription Redeem Point Wallet", icon: AccountBalanceWalletRoundedIcon, to: "/admin/workflows/redeem-point-coupon-summary", metrics: [{ label: "Count", value: number(coupons.redeemed) }, { label: "Amount Approval", value: "-" }] },
      { title: "Smart Product Package Monthly SPP", icon: ShoppingCartRoundedIcon, to: "/admin/promo-purchases?kind=monthly&status=APPROVED", metrics: packageMetrics(smartProduct1000.overall) },
      { title: "Smart Product Package Coupon Pocket", icon: ConfirmationNumberRoundedIcon, to: "/admin/promo-purchases?kind=monthly&status=APPROVED", metrics: packageMetrics(smartProduct1000.couponPocket) },
      { title: "Smart Product Package Self Package Pocket", icon: ShoppingCartRoundedIcon, to: "/admin/promo-purchases?kind=monthly&status=APPROVED", metrics: packageMetrics(smartProduct1000.selfPackagePocket) },
      { title: "Smart Product Package Add Money", icon: AccountBalanceWalletRoundedIcon, to: "/admin/promo-purchases?kind=monthly&status=APPROVED", metrics: packageMetrics(smartProduct1000.addMoney) },
      ...
      { title: "Join Subscription 5 Matrix", icon: AccountTreeRoundedIcon, to: "/admin/commissions/history", metrics: [{ label: "ID Count", value: "-" }] },
      ...
      { title: "Join Subscription 3 Matrix", icon: AccountTreeRoundedIcon, to: "/admin/autopool", metrics: [{ label: "ID Count", value: number(autopool.total) }] },
